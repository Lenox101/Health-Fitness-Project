...
--
-- Table structure for table `aerobicsapplicants`
--

DROP TABLE IF EXISTS `aerobicsapplicants`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `aerobicsapplicants` (
  ...
  KEY `FK_aerobicsapplicants_members` (`MemberId`)
