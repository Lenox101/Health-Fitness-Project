...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE trainers_tbl SET first_name = '$fname', last_name = '$lname', username = '$uname', city = '$city',contact = '$contact',trainer_type = '$trainer_type', gender = '$gender',status = '$status'
            WHERE id='$trainerid'";
...
<body>
    ...
    <form id="editForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="POST">
        <!----Get user ID----->
        <p>Trainer ID: </p>
        <input type="text" name="trainerid" id="trainerid" value="<?php echo htmlspecialchars(isset($_GET['trainerid']) ? $_GET['trainerid'] : ''); ?>" readonly><br>

        <label for="firstName">First Name:</label>
        <input type="text" id="firstName" name="fname" value="<?php echo htmlspecialchars(isset($_GET['fname']) ? $_GET['fname'] : ''); ?>"  onkeypress="return restrictNumbers(event)"><br>

        <label for="lastName">Last Name:</label>
        <input type="text" id="lastName" name="lname" value="<?php echo htmlspecialchars(isset($_GET['lname']) ? $_GET['lname'] : ''); ?>" onkeypress="return restrictNumbers(event)"><br>

        <label for="username">Username:</label>
        <input type="text" id="username" name="uname" value="<?php echo htmlspecialchars(isset($_GET['uname']) ? $_GET['uname'] : ''); ?>" onkeypress="return restrictNumbers(event)"><br>

        <label for="city">City:</label><br>
        <select id="cityDropdown" name="cityDropdown" required>
