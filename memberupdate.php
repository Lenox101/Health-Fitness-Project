...
if (isset($_POST['submit'])) {
	...
	$sql = "UPDATE members_tbl SET fname = '$fname', lname = '$lname', uname = '$uname', city = '$city', weight = '$weight', gender = '$gender', contact = '$contact'
            WHERE id='$memberid'";
...
<body>
	...
	<form id="editForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="POST">
		<!----Get user ID----->
		<p>Member ID: </p>
		<input type="text" name="memberid" id="memberid" value="<?php echo htmlspecialchars(isset($_GET['memberid']) ? $_GET['memberid'] : ''); ?>" readonly><br>
		...
		<input type="text" id="username" value="<?php echo htmlspecialchars(isset($_GET['uname']) ? $_GET['uname'] : ''); ?>" name="uname"><br>
